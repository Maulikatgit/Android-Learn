...
public class pra7 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String codeSnippet = readFileFromAssets("pra7.xml");
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()) {
                    ...
                    case R.id.menu_search:
                        String codeSnippet1 = readFileFromAssets("pra7.java");
                    ...
                    case R.id.menu_profile:
                        ...
                        profileImageView3.setImageResource(R.drawable.pra7);
