...
public class pra8 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String codeSnippet = readFileFromAssets("pra8.xml");
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()) {
                    ...
                    case R.id.menu_search:
                        String codeSnippet1 = readFileFromAssets("pra8.java");
                    ...
                    case R.id.menu_profile:
                        ...
                        profileImageView3.setImageResource(R.drawable.pra8);
