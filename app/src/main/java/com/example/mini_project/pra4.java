...
public class pra4 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String codeSnippet = readFileFromAssets("pra4.xml");
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()) {
                    ...
                    case R.id.menu_search:
                        String codeSnippet1 = readFileFromAssets("pra4.java");
                    ...
                    case R.id.menu_profile:
                        ...
                        profileImageView3.setImageResource(R.drawable.pra4);
